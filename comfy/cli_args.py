...
parser.add_argument("--prefault-models", action="store_true", help="Pre-read model files to fault pages into RAM before mmap. Fixes slow mmap-to-GPU on unified memory systems like DGX Spark.")
